<?php
    ...
    $sql="INSERT INTO tblstudents (StdId,FirstName,LastName,EmailId,Password,Gender,Dob,Trade,Address,City,Country,Phonenumber,Status) VALUES(:stdid,:fname,:lname,:email,:password,:gender,:dob,:trade,:address,:city,:country,:mobileno,:status)";
    $query = $dbh->prepare($sql);
    $query->bindParam(':stdid',$sdtid,PDO::PARAM_STR);
...
<head>
    ...
    <title>Staff Panel - Student Leave</title>
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addstd" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label">Preferred Trade</label>
                                            <select class="custom-select" name="trade" autocomplete="off">
